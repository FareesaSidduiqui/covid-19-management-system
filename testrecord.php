...
<link href="https://fonts.googleapis.com/css2?family=Poppins:ital,wght@0,100;0,200;0,300;0,400;0,500;0,600;0,700;0,800;0,900;1,100&display=swap" rel="stylesheet">
    ...
    <nav class = "navbar navbar-expand-sm nav_style p-2">
        ...
        <div class="main-div mt-3">
            <h3 class="text-center text-uppercase mt-5">Test History:</h3>
                ...
                <div class="table-responsive">
                   <table id="customers">
                    ...
                    <tr>
                        ...
                        <th>Patient ID</th>
                        <th>Test Type</th>
                        <th>Test Time Slot</th>
                        <th>Report Status</th>
                        <th>Report</th>
                        <th>Report upload time</th>
                    ...
                    <tbody>
                       ...
                       $selectquery = " SELECT * from testrecordtbl";
                       ...
                       $querys = mysqli_query($con,$selectquery);
                         ...
                         <td><?php echo$res['patientID'];?></td>
                         <td><?php echo$res['TestType'];?></td>
                         <td><?php echo$res['TestTimeSlot'];?></td>
                         <td><?php echo$res['ReportStatus'];?></td>
                         <td><?php echo$res['FinalReport'];?></td>
                         <td><?php echo$res['ReportUploadTime'];?></td>
                         <td><?php echo$res['phlebotomistID'];?></td>
                         <td><a href="recordadd.php" data-toggle="tooltip" data-placement="top" title="ADD">
                         <i class="fa fa-plus" aria-hidden="true"></i></a></td> 
                         <td><a href="recordupd.php?updateid='.$id.'" data-toggle="tooltip" data-placement="top" title="UPDATE">
